...
export default function About(){
    return (
        <div className="w-full h-full flex flex-col items-center xl:flex-row border-t-4 gap-4 border-white/30">


            <div className="w-full max-w-172 xl:w-1/3 h-[70dvh] xl:h-full flex flex-col trans">
            ...
            <div className="w-full max-w-172 xl:w-1/3 h-[70dvh] xl:h-full flex flex-col trans">
                <div className="h-3/5 flex items-center justify-center order-1 xl:order-2 ">
                    <div className="w-4/5 h-4/5 relative overflow-clip">
                        <Image
                            draggable={false}
                            className="object-cover object-center"
            ...
            <div className="w-full max-w-172 xl:w-1/3 h-[70dvh] xl:h-full flex flex-col trans">
                <div className="h-3/5 flex items-center justify-center order-1">
                    <div className="w-4/5 h-4/5 bg-white/40 relative">
                        <iframe
